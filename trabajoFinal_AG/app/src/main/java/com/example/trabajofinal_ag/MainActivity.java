...
public class MainActivity extends AppCompatActivity {
    ...
    private void startDownload(String urlText, String format) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(MainActivity.this, "Error al conectar con el servidor", Toast.LENGTH_SHORT).show());
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful() && response.body() != null && response.body().contentLength() > 0) {
                    ...
                    runOnUiThread(() -> Toast.makeText(MainActivity.this, "Archivo guardado en descargas", Toast.LENGTH_SHORT).show());
                    ...
                    runOnUiThread(() -> Toast.makeText(MainActivity.this, "Error en la descarga", Toast.LENGTH_SHORT).show());
                }
            }
        });
    }
    ...
    private void notifyServerFileDownloaded(String fileName) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(MainActivity.this, "Error al notificar al servidor", Toast.LENGTH_SHORT).show());
            }

            @Override
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    runOnUiThread(() -> Toast.makeText(MainActivity.this, "El servidor ha recibido la notificación para eliminar el archivo", Toast.LENGTH_SHORT).show());
                } else {
                    runOnUiThread(() -> Toast.makeText(MainActivity.this, "Error al notificar al servidor", Toast.LENGTH_SHORT).show());
                }
            }
    ...
    private void saveDownloadHistory(String fileName, String format, String date, String url) {
        ...
        executor.execute(() -> {
            ...
            runOnUiThread(() -> {
                Toast.makeText(MainActivity.this, "Descarga guardada en historial", Toast.LENGTH_LONG).show();
            });
        });
    }
